    ...
    return (
      <div className="fixed bottom-6 right-6 z-50">
        <button
          ...
          aria-label="Maximizar botão do WhatsApp"
      ...
      <div className="relative">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div>
              {/* Alteração: Cor do texto principal para um tom mais escuro */}
              <div className="font-semibold text-sm text-gray-900">Fale com um especialista</div>
              {/* Alteração: Cor do texto secundário para um tom mais escuro */}
